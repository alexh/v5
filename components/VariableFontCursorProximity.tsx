  ...
  (
    ...
    useAnimationFrame(() => {
      ...
      letterRefs.current.forEach((letterRef, index) => {
        ...
        console.log(`Letter ${index} distance:`, distance, 'Mouse pos:', mousePositionRef.current)
        ...
        console.log(`Letter ${index} falloff:`, falloffValue)
        ...
        console.log(`Letter ${index} settings:`, newSettings)
